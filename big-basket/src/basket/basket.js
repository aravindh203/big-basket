...
const Basket = () => {
  ...
  var settings = {dots: false,infinite: true,speed: 500,slidesToShow: 5,slidesToScroll: 5,autoplay: false};
                    ...
                    <Card className="card">
                      <CardActionArea>
                        ...
                        <CardContent>
                          ...
                          <Typography onClick={() =>goToDetails(value.category, value.id)} gutterBottom variant="body2" className="product-name">{value.productName}</Typography>
                        </CardContent>
                      </CardActionArea>
                        ...
                        <div className="card-actions">
                          ...
                          {value.addTocardAuthendication ? (
                            <div className="add-to-card-button">
                              <div>
                                <button
                                  className="add-button" onClick={(event) =>updateValues(event,value.weight,value.id,value.category)}>+</button>
